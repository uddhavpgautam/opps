...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleBoxArticles.title'
        db.add_column(u'articles_articleboxarticles', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArticleBoxArticles.short_title'
        db.add_column(u'articles_articleboxarticles', 'short_title',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArticleBoxArticles.main_image'
        db.add_column(u'articles_articleboxarticles', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, blank=True, on_delete=models.SET_NULL),
                      keep_default=False)

        # Adding field 'ArticleBoxArticles.main_image_caption'
        db.add_column(u'articles_articleboxarticles', 'main_image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=4000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleBoxArticles.title'
        db.delete_column(u'articles_articleboxarticles', 'title')

        # Deleting field 'ArticleBoxArticles.short_title'
        db.delete_column(u'articles_articleboxarticles', 'short_title')

        # Deleting field 'ArticleBoxArticles.main_image'
        db.delete_column(u'articles_articleboxarticles', 'main_image_id')

        # Deleting field 'ArticleBoxArticles.main_image_caption'
        db.delete_column(u'articles_articleboxarticles', 'main_image_caption')
    ...
    models = {
        ...
        u'articles.articlebox': {
            ...
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'queryset': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'articlebox_querysets'", 'null': 'True', 'to': u"orm['boxes.QuerySet']"}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['sites.Site']"}),
        ...
        u'articles.articleboxarticles': {
            'Meta': {'ordering': "('order',)", 'object_name': 'ArticleBoxArticles'},
        ...
        u'articles.link': {
            'Meta': {'ordering': "['-date_available', 'title', 'channel_long_slug']", 'object_name': 'Link', '_ormbases': [u'articles.Article']},
            u'article_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['articles.Article']", 'unique': 'True', 'primary_key': 'True'}),
            'articles': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'link_article'", 'null': 'True', 'to': u"orm['articles.Article']"}),
